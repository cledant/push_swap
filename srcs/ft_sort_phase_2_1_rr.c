...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/14 15:34:41 by cledant           #+#    #+#             */
/*   Updated: 2016/05/14 15:38:17 by cledant          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline int		ft_do_rev_rotate(t_stack *a, t_stack *b,
...
int						ft_sort_phase_2_1_rr(t_stack *a, t_stack *b,
							t_list **list, int debug)
{
	if (a->in == 0 || a->in == 1)
		return (ft_do_push(a, b, list, debug));
	else
	{
		while (1)
		{
			...
			{
				if (ft_do_rev_rotate(a, b, list, debug) == -1)
					return (-1);
			}
		}
		return (1);
